...
viimo = Math.floor( ( Math.random ( ) *3 ));

switch (viimo) {
  case 0:
    location.href = "https://www.sanakirja.org/";
    break;
  case 1:
    location.href = "https://ekirjasto.kirjastot.fi/";
    break;
  case 2:
    location.href = "https://yle.fi/uutiset/18-211012";
    break;
}
