...
switch (viimo) {
  case 0:
    location.href = "https://kevat2022.tylykoodaa.fi/eetu/";
    break;
  case 1:
    location.href = "https://www.christianity.com/jesus/";
    break;
  case 2:
    location.href = "https://quran.com/";
    break;
  case 3:
    location.href = "https://biblehub.com/genesis/1.htm";
    break;
}
